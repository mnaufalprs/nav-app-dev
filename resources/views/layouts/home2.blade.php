    ...
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <main class="p-4 md:ml-64 h-auto pt-20">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                <div
                    class="border-2 border-dashed border-gray-300 rounded-lg dark:border-gray-600 h-32 md:h-64 md:p-4"
                >
                
                  <div class="flex justify-between">
                    <div>
                      <h5 class="leading-none text-1x1 font-bold text-gray-900 dark:text-white pb-1">32.4k</h5>
